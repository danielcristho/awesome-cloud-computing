...
> Tools and practices for observing cloud and cloud-native systems,
> including metrics, logs, and traces in dynamic and distributed environments.

| Name | Description | Link |
|------|-------------|------|
| **Grafana** | Visualization and analytics platform commonly used for cloud-native monitoring dashboards. | [https://grafana.com](https://grafana.com) |
| **Prometheus** | Cloud-native metrics collection and alerting system designed for dynamic environments. | [https://prometheus.io](https://prometheus.io) |
| **VictoriaMetrics** | Scalable time-series database optimized for high-volume cloud monitoring workloads. | [https://victoriametrics.com](https://victoriametrics.com) |
