...
|------|-------------|---------------|----------|
| **Ansible** | Open-source automation tool commonly used for configuration management and infrastructure automation. | [Docs](https://www.ansible.com) | [Getting Started](https://docs.ansible.com/ansible/latest/getting_started/index.html) |
...
| **Chef** | Open-source platform for configuration management and infrastructure automation. | [Docs](https://docs.chef.io) | [Chef Tutorials](https://learn.chef.io) |
